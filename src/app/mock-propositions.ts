...
export const PROPOSITIONS: PropositionModel[] = [
  ...
  {id: 1, name: 'Перша тестова пропозиція', authorId: 1, createDate: Date(), status: 1, location: [50.3413014, 30.5962901], images: [], description: 'some description', authorName: 'Andrii', authorPhoneNumber: '0946643956'},
